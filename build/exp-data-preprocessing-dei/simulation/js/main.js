...
print("Total missing values after handling:", df_clean.isna().sum().sum())`,
      ...
      {
        code: `<div class="output-success"># (NORMALIZATION) Select numerical columns to apply Min-Max scaling </div>
        
num_cols = ["Age", "Fare"]
df_num = df_clean[num_cols].copy()
print("MinMaxScaler imported and numerical columns selected")`,
...
print("Numerical columns balanced and scaled between 0 and 1")`,
...
plt.show()`,
    ...
    <div style="text-align:left;">
      ...
      {
        code: `<div class="output-success"># (ENCODING CATEGORICAL VARIABLES) List and display categorical columns</div>
